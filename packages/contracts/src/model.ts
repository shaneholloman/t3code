...
import type { BuiltInDriverKind } from "./providerInstance.ts";
...
export const DEFAULT_MODEL_BY_PROVIDER: Record<BuiltInDriverKind, string> = {
  codex: "gpt-5.4",
...
export const DEFAULT_GIT_TEXT_GENERATION_MODEL_BY_PROVIDER: Record<BuiltInDriverKind, string> = {
  codex: "gpt-5.4-mini",
...
export const MODEL_SLUG_ALIASES_BY_PROVIDER: Record<BuiltInDriverKind, Record<string, string>> = {
  codex: {
    "gpt-5-codex": "gpt-5.4",
    "5.4": "gpt-5.4",
    "5.3": "gpt-5.3-codex",
...
export const PROVIDER_DISPLAY_NAMES: Record<BuiltInDriverKind, string> = {
  codex: "Codex",
  claudeAgent: "Claude",
  cursor: "Cursor",
  opencode: "OpenCode",
